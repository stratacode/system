 ...
 * to do hash-table lookups for each getProperty and setProperty.
...
public interface IBeanMapper extends IBinding {
   /** Properties defined on an interface need to do a dynamic lookup to retrieve the position.  This is the sentinenl value for those properties */
