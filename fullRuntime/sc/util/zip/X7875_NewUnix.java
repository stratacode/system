...
import static sc.util.zip.ZipUtil.reverse;
import static sc.util.zip.ZipUtil.signedByteToUnsignedInt;
import static sc.util.zip.ZipUtil.unsignedIntToSignedByte;
