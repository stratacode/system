      ...
      if (isMain && (model = getJavaModel()) != null) {
         ...
         if (mainSettings != null) {
            ...
            if (disabled == null || !disabled) {
               ...
               if (defaultArgs != null && defaultArgs.length() > 0 && !defaultArgs.endsWith(" "))
               ...
               if (produceJar != null && produceJar) {
                  ...
                  sharedArgs = "java" + debugStr + memStr + vmParams +
                                      " -jar \"`dirname $0`/" + FileUtil.getFileName(execName) + ".jar\"";
               }
               else {
               ...
               sharedArgs += defaultArgs + " -restartArgsFile /tmp/restart$$.tmp";
               command = sharedArgs + " $*";
