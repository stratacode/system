...
public class ParentParseNode extends AbstractParseNode {
   ...
   public boolean equals(Object other) {
      ...
      ParentParseNode opn = (ParentParseNode) other;

      ArrayList tlist = this.children;
      ArrayList olist = opn.children;
      if (tlist == null) {
         if (olist != null)
            return false;
         return true;
      ...
      if (tsz != osz)
         return false;
      for (int i = 0; i < tsz; i++) {
         Object tchild = tlist.get(i);
         Object ochild = olist.get(i);
         if (tchild != ochild) {
            if (tchild == null || ochild == null)
               return false;
            if (!tchild.equals(ochild))
               return false;
         }
      }
      return true;
