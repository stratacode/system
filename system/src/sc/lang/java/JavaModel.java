            ...
            if (needsTransform()) {
               ...
               */
               if (transformedModel != null && transformedModel.parseNode == null)
                  clearTransformed(); // this model wasn't parsed so need to regenerate the parse node tree
      ...
      if (type == null && modelLayer != null) {
         ...
         if ((type = layeredSystem.getImportedStaticType(name, toFilterLayer, modelLayer)) != null) {
            ...
            if (type == null) { // This used to be an 'assert; but caused an error in the IDE so turned it into a type error
               displayTypeError("Static imported type - no member with name: " + name + " for: ");
            }
         }
      }
      if (type != null) {
      ...
      if (idx != null) {
         ...
         if (ref != null) {
            ...
            if (model == null) {
               ...
               if (srcEnt != null) {
                  System.err.println("*** Parsing file for getSrcStatementForGenLine"); // TODO: do we need this code path anymore?
