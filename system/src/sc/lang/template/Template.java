...
public class Template extends SCModel implements IValueNode, ITypeDeclaration {
   ...
   public Object definesMethod(String name, List<?> types, ITypeParamContext ctx, Object refType, boolean isTransformed, boolean staticOnly, Object inferredType) {
      if (defaultExtendsType != null) {
         Object methResult = ModelUtil.definesMethod(defaultExtendsType, name, types, ctx, refType, isTransformed, staticOnly, inferredType);
         if (methResult != null)
            return methResult;
      }
      Object o;
      ...
      if (templateDeclarations != null) {
         for (Object td:templateDeclarations) {
            if (td instanceof TemplateStatement) {
               if ((o = ((TemplateStatement) td).definesMethod(name, types, ctx, refType, isTransformed, staticOnly, inferredType)) != null)
                  return o;
            }
            else if (td instanceof TemplateDeclaration) {
               if ((o = ((TemplateDeclaration) td).definesMethod(name, types, ctx, refType, isTransformed, staticOnly, inferredType)) != null)
                  return o;
            }
         }
      }
      ...
      if (refType == this && rootType != null) {
         o = ModelUtil.definesMethod(rootType, name, types, ctx, rootType, isTransformed, staticOnly, inferredType);
         if (o != null)
            return o;
      }
   ...
   private void initOutputMethod() {
      ...
      if (outputMethod == null) {
         if (singleElementType && rootType != null) {
            outputRuntimeMethod = ModelUtil.definesMethod(rootType, "output", null, null, null, false, false, null);
            ...
            if (types.size() != 0) {
               ...
               if (!(decl instanceof MethodDefinition))
                  ...
                  if (rootType.declaresMethod(name, null, null, null, false, null, false) != null)
                  ...
                  if (outputMethod != null && outputMethod.parameters != null && outputMethod.parameters.getNumParameters() > 0) {
                     outputRuntimeMethod = rootType.definesMethod("output", null, null, null, false, false, null);
                     if (outputRuntimeMethod == null)
                        displayError("Missing output() method for root template type: ");
                  }
               }
